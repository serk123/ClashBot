...
Func GetResources() ;Reads resources
	While 1
		...
		If $searchDead Then $txtDead = "Dead" ;GB
		...
		SetLog("(" & $SearchCount & ") [G]: " & $searchGold & Tab($searchGold, 7) & "[E]: " & $searchElixir & Tab($searchElixir, 7) & "[D]: " & $searchDark & Tab($searchDark, 4) & "[T]: " & $searchTrophy & Tab($searchTrophy, 3) & "[TH]: " & $searchTH & ", " & $THLoc & ", " & $txtDead, $COLOR_BLUE) ;GB
		ExitLoop
	WEnd
