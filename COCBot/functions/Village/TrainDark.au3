Func TrainDark()
   If $ichkDarkTroop = 0 Then Return
	...
	If $itxtDarkBarrack1 <> 0 And ($fullArmy Or $FirstStart) Then
	    $TrainDrax1 = True
	EndIf
	If $itxtDarkBarrack2 <> 0 And ($fullArmy Or $FirstStart) Then
	    $TrainDrax2 = True
	EndIf
...
If GUICtrlRead($txtDarkBarrack1) <> "0" And $i = 0 And $TrainDrax1 = True Then
				If $DarkBarrackTroop[$i] = 0 Then
					    ...
					    If $itxtDarkBarrack1 <= 10 And ($fullArmy Or $FirstStart) Then
							TrainIt($eMinion, $itxtDarkBarrack1)
						    $TrainDrax1 = False
					    SetLog("Dark Barrack 1 Train Minion Completed...", $COLOR_BLUE)
						ElseIf $itxtDarkBarrack1 > 10 And ($fullArmy Or $FirstStart) Then
							TrainIt($eMinion, 10)
				...
				If $DarkBarrackTroop[$i] = 1 Then
						...
						ElseIf $LeftRax1 > 5 And ($troopHog <= 5) Then
							TrainIt($eHog, 5)
							$LeftRax1 = ($ClickRax1 - 5)
						    $ClickRax1 = $LeftRax1
					    SetLog("Dark Barrack 1 Hog Remaining : " & $LeftRax1 , $COLOR_BLUE)
...
If GUICtrlRead($txtDarkBarrack2) <> "0" And $i = 1 And $TrainDrax2 = True Then
				If $DarkBarrackTroop[$i] = 0 Then
					    ...
					    If $itxtDarkBarrack2 <= 10 And ($fullArmy Or $FirstStart) Then
							TrainIt($eMinion, $itxtDarkBarrack2)
						    $TrainDrax2 = False
					    SetLog("Dark Barrack 2 Train Minion Completed...", $COLOR_BLUE)
						ElseIf $itxtDarkBarrack2 > 10 And ($fullArmy Or $FirstStart) Then
							TrainIt($eMinion, 10)
				...
				If $DarkBarrackTroop[$i] = 1 Then
						...
						ElseIf $LeftRax2 > 5 And ($troopHog2 <= 5) Then
							TrainIt($eHog, 5)
							$LeftRax2 = ($ClickRax2 - 5)
						    $ClickRax2 = $LeftRax2
					    SetLog("Dark Barrack 2 Hog Remaining : " & $LeftRax2 , $COLOR_BLUE)
