...
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|W.Breaker|Balloon|Wizard|Healer|Dragon|Pekka|Nothing", "Barbarians")
$cmbBarrack2 = GUICtrlCreateCombo("", 275, 155, 110, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|W.Breaker|Balloon|Wizard|Healer|Dragon|Pekka|Nothing", "Archers")
...
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|W.Breaker|Balloon|Wizard|Healer|Dragon|Pekka|Nothing", "Goblins")
GUICtrlCreateGroup("", -99, -99, 1, 1)
...
$btnLocateDBarrack = GUICtrlCreateButton("Disable Dark Barrack", 213, 270, 170, 25)
...
GUICtrlSetTip(-1, "Minimum Gold you have to proceed the upgrade, does not mean minimum resource require for the wall")
...
GUICtrlSetTip(-1, "Minimum Elixir you have to proceed the upgrade, does not mean minimum resource require for the wall")
$txtWallMinElixir = GUICtrlCreateInput("1300000", 325, 112, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
$UseGoldElix = GUICtrlCreateRadio("Use Elixir and use Gold if not enough Elixir", 40, 137, 250, 17)
...
$txtUpgradeR1 = GUICtrlCreateInput("", 275, 189, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
...
$txtUpgradeR2 = GUICtrlCreateInput("", 275, 219, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
...
$txtUpgradeR2 = GUICtrlCreateInput("", 275, 249, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
GUICtrlCreateGroup("", -99, -99, 1, 1)
